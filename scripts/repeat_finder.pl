...
my $rm_out_file  = $ENV{'RM_OUT'};		# "data/papAnu2.fa.out";
my $trf_out_file = $ENV{'TRF_OUT'};		# "data/papAnu2.trf.bed";

my $map_file_full = "data/$ENV{'INPUT_PREFIX'}.map";
...
$exclusion_regions_cmd .= "${BEDTOOLS}/bedtools merge -i stdin > $exclude_bed";
